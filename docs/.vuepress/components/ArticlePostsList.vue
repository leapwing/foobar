        ...
        >
          <div class="flex-1">
            <router-link :to="page.path" class>
              <p v-if="page.frontmatter.date" class="md:inline-block text-gray-900 my-0 text-sm">
                Published on
                <small
              ...
              <p v-if="page.lastUpdated" class="md:inline-block text-gray-900 md:my-0 my-1 text-sm">
                Last updated on
                <small
                  class="p-1 bg-gray-600 text-white rounded"
              ...
              <p class="text-gray-700 my-0">{{ page.frontmatter.description }}</p>
            </router-link>
            <div class="my-2">
              <div
